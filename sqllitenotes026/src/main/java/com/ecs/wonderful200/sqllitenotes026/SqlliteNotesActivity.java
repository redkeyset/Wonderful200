...
import com.ecs.wonderful200.sqllitenotes026.adapter.MainAdapter;
import com.ecs.wonderful200.sqllitenotes026.bean.SQLBean;
import com.ecs.wonderful200.sqllitenotes026.db.DatabaseOperation;
import com.ecs.wonderful200.sqllitenotes026.doubledatepicker.DoubleDatePickerDialog;
import com.ecs.wonderful200.sqllitenotes026.view.MyGridView;
...
public class SqlliteNotesActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sqllitenotes);
                        ...
                        switch (which) {
                            ...
                            case 0:
                                if ("0".equals(locktype)) {//判断是否添加了秘密锁0没有
                                    Intent intent = new Intent(SqlliteNotesActivity.this,
    ...
    class ItemClickEvent implements OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position,
            ...
            if ("0".equals(locktype)) {
                Intent intent = new Intent(SqlliteNotesActivity.this, AddActivity.class);
    ...
    public void inputTitleDialog(final String lock, final int idtype,
        ...
        builder.setPositiveButton("确认", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                ...
                if ("".equals(inputName)) {
                    Toast.makeText(SqlliteNotesActivity.this, "密码不能为空请重新输入！",
                    ...
                    if (inputName.equals(lock)) {
                        ...
                        Toast.makeText(SqlliteNotesActivity.this, "密码不正确！",
                                Toast.LENGTH_LONG).show();
                    }
                }
            }
    ...
    public void onSearch(View v) {
        ...
        if ("".equals(ek)) {//判断搜索关键词是否为空
            Toast.makeText(SqlliteNotesActivity.this, "请输入关键词！", Toast.LENGTH_LONG)
                    .show();
        } else {//搜索不为空
            //进入搜索结果页
            Intent intent = new Intent(SqlliteNotesActivity.this, SearchActivity.class);
    ...
    public void onData(View v) {
        ...
        new DoubleDatePickerDialog(SqlliteNotesActivity.this, 0,
                new DoubleDatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker startDatePicker,
                        ...
                        if (startYear < endYear || startYear == endYear
                            ...
                            Toast.makeText(SqlliteNotesActivity.this, "日期选择错误请重新选择！",
                                    Toast.LENGTH_LONG).show();
                        }
                    }
    ...
    public void onAbout(View v) {
        Intent intent = new Intent(SqlliteNotesActivity.this, About.class);
        startActivity(intent);
    }
}
